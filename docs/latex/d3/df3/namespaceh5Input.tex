...
{\em file\+Name} & The name of the input H\+D\+F5 file \\
\hline
{\em Ts} & A vector of floats where the temperatures will be placed \\
\hline
{\em Hs} & A vector of floats where the fields will be placed \\
\hline
\end{DoxyParams}
\index{h5\+Input@{h5\+Input}!get\+Spins@{get\+Spins}}
...
{\em file\+Name} & The name of the input H\+D\+F5 file \\
\hline
{\em Tind} & The index of the chosen temperature \\
\hline
{\em Hind} & The index of the chosen field \\
\hline
{\em geometry} & The geometry of the lattice \\
\hline
{\em directions} & The directions of the spins \\
\hline
\end{DoxyParams}
