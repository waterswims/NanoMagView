...
{\em slice\+\_\+pos\+\_\+in} & The locations of each slice in real space \\
\hline
{\em arrow\+On} & Are spin arros on? \\
\hline
{\em all\+Arrow} & Are all spin arrows on? \\
\hline
{\em slices} & Which slices of spin arrows should be shown? \\
\hline
{\em iso\+On} & Are isosurfaces on? \\
\hline
{\em iso\+Val} & What is the value of the isosurfaces? \\
\hline
...
\begin{DoxyParams}{Parameters}
{\em geometry} & The positions of the sites \\
\hline
{\em vectors} & The vectors associated with the geometry \\
\hline
\end{DoxyParams}
